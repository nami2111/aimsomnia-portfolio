...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const createCollectionRow = (item) => {
    ...
    a.target = '_blank';
    a.rel = 'noopener';
    a.className = 'collection-link group flex items-baseline justify-between gap-4 border-b-2 border-black/[0.07] dark:border-white/[0.07] py-2.5 hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition';
  ...
  const createVibeRow = (item) => {
    ...
    a.target = '_blank';
    a.rel = 'noopener';
    a.className = 'project-link group flex items-start justify-between gap-4 border-b-2 border-black/[0.07] dark:border-white/[0.07] py-3 hover:bg-black/[0.03] dark:hover:bg-white/[0.03] transition';
